...
/obj/structure/flora/flamer_fire_act(burnlevel, burnflags, firesource)
	if(!CHECK_BITFIELD(burnflags, BURN_ENVIRONMENT))
		return
...
/obj/structure/flora/tree/flamer_fire_act(burnlevel, burnflags, firesource)
