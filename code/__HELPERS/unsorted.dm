...
/proc/fade_out(image/I, list/show_to, time = 0.5 SECONDS)
	animate(I, alpha = 0, time = time, easing = EASE_IN)
	addtimer(CALLBACK(GLOBAL_PROC, GLOBAL_PROC_REF(remove_images_from_clients), I, show_to), time)
